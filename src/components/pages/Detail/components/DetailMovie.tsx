...
const DetailMovie = (props: any) => {
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && detailMovie?.vote_average) {
      circle();
    }
      ...
      <div className="flex flex-wrap">
          ...
          <div>
            {!isLoading ? (
              <div className={`relative ${castingScrolled ? "scrolled" : ""}`} id="cast_scroller">
                ...
                <Link href={`/cast/movie-${id}`}>Full Cast & Crew</Link>
              </div>
            ) : (
        ...
        <div className="md:w-1/3 w-full min-w-[260px] md:px-3 mt-7 md:mt-0">
          <div className="h-full">
            ...
            <div className="w-full mb-4">
              <GeneralFieldSkeleton isLoading={isLoading} width="19%">
            ...
            <div className="w-full mb-4">
              <GeneralFieldSkeleton isLoading={isLoading} width="21%">
