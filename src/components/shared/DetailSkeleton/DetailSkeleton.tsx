const DetailSkeleton = () => {
  return (
    <>
      <div className={`flex-none w-full md:w-1/3 max-w-[300px] rounded-lg overflow-hidden	`}>
      ...
      <div className={`md:w-2/3 max-h-full rounded-lg overflow-hidden px-8 flex flex-col justify-center`}>
